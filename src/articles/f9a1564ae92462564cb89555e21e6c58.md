...
3° Liste des personnes appelées à réaliser effectivement
	    les expertises, avec toutes indications permettant d'apprécier,
	    pour chacune d'elles, sa qualification et son expérience dans le ou les domaines de l'agrément sollicité ;

4° Note
	    détaillée exposant les principales méthodes d'intervention mises en œuvre ;

5° (Décret n° 2011-1953 du 23 décembre 2011) « Déclaration des activités autres que les expertises mentionnées à l'article L. 4614-12 ; »

6° Tarifs applicables
	    aux expertises réalisées dans le cadre de l'agrément prévu par l'article L. 4614-12 ;
