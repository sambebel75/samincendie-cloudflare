...
## 1.  Objet
## 2.  Principes
## 3. Dispositions communes aux deux systèmes
## 4. Dispositions spécifiques à chaque système
## 5. Calculs et mesures
## Annexe - Schémas désenfumage
...
Les ventilateurs d'extraction sont classés F400120.
...
3.6. Mise à l'arrêt des ventilateurs (processus de mise en sécurité actionné)
...
Les calculs de désenfumage des circulations horizontales communes sont faits sur la base du compartiment.

Dans le cas où ce compartiment est constitué de plusieurs niveaux, les calculs sont faits pour la totalité des niveaux, mais la mise en route du désenfumage se fait par niveau dans les conditions précisées à l'article GH 49.
